...
def main():
    ...
    # plasma_system.render(view=True)
...
def create_dri_eaf_system(system_name='dri eaf steelmaking') -> System:
    ...
    hot_h2o_h2_out = Flow('h2 h2o', mass=0.0)
    ...
    hot_h2o_h2_in = Flow('h2 h2o', mass=0.0)
...
def create_hybrid_system(system_name='hybrid steelmaking', prereduction_perc=33.333333) -> System:
    ...
    plasma_smelter = Device('plama smelter')
    ...
    carbon_off_gas = Flow('co co2', mass=0.0)
    ...
    hot_h2o_h2_in = Flow('h2 h2o co co2', mass=0.0)
    ...
    fluidized_bed_off_gas = Flow('h2 h2o', mass=0.0)
