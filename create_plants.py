...
def create_plasma_system(system_name: str ='plasma steelmaking',
    ...
    plasma_system.system_vars['plasma reactor thermal eff percet'] = 65.0 # badr2007, fig 21, 
...
def create_dri_eaf_system(system_name='dri eaf steelmaking', 
    ...
    dri_eaf_system.system_vars['ore heater temp K'] = celsius_to_kelvin(500)
...
def create_hybrid_system(system_name='hybrid steelmaking',  
    ...
    hybrid_system.system_vars['plasma reactor thermal eff percet'] = 65.0 # badr2007, fig 21, 
